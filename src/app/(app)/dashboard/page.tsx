...
export default function DashboardPage() {
  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="mt-10 py-6 border-t border-surface-200 text-center">
        <p className="text-[10px] font-bold tracking-widest uppercase text-surface-400">
          POWERED BY COLLAB FORCE HEALTH SYSTEM
        </p>
      </div>
    </div>
  );
